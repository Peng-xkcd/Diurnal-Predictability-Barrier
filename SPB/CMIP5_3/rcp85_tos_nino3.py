...
for i in range(0, len(list_dir)):
    ...
    if os.path.isfile(path_nc):
        ...
        #去趋势
        polynomial(t_enson, order=2, plot='E:\\JYS_DATA\\Figs-rcp85_tos_detrended_nino3\\{}.png'.format(list_dir[i]))
        ...
        plt.savefig('E:\\JYS_DATA\\Figs-rcp85_tos_nino3\\{}.png'.format(list_dir[i]))
        plt.close()
